...
import { parts, companies, cars, categories } from "@/data/database";
...
function ProductsContent() {
  ...
  const filteredParts = useMemo(() => {
    return parts.filter((part) => {
      const text =
        `${part.name || ""} ${part.company || ""} ${part.car || ""} ${part.category || ""}`.toLowerCase();
      ...
      const companyMatch = !selectedCompany || part.company === selectedCompany;

      const carMatch = !selectedCar || part.car === selectedCar;

      return searchMatch && categoryMatch && companyMatch && carMatch;
    });
  }, [search, selectedCategory, selectedCompany, selectedCar]);
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-gray-500">
                Ищите деталь по названию, автомобилю, компании или категории.
              </p>
            </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        <div className="grid gap-8 lg:grid-cols-[250px_1fr]">
          <aside className="space-y-6">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5">
              <h2 className="font-bold">Производитель</h2>
            ...
            {selectedCompany && (
              <div className="rounded-2xl border border-gray-200 bg-white p-5">
                <h2 className="font-bold">Автомобиль</h2>
          ...
          <div>
            <div className="mb-6 flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-black">Запчасти</h2>
            ...
            {filteredParts.length === 0 ? (
              <div className="rounded-3xl border border-gray-200 bg-white py-20 text-center">
                ...
                <h3 className="mt-5 text-xl font-bold">Ничего не найдено</h3>
                ...
                {filteredParts.map((part) => (
                  ...
                  >
                    ...
                    <Link
                      ...
                      className="relative flex h-52 items-center justify-center bg-gray-100"
                    >
                      {part.image ? (
                        <img
                          src={part.image}
                    ...
                    <div className="p-5">
                      ...
                      <h3 className="mt-2 text-lg font-bold">{part.name}</h3>

                      <p className="mt-1 text-sm text-gray-500">{part.car}</p>
                      ...
                      <div className="mt-5">
                        ...
                        <p className="mt-1 text-xs text-gray-400">
                          ⭐ {part.rating || "—"} · В наличии: {part.stock ?? 0}
                        </p>
                      </div>
